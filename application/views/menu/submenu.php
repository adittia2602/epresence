      <div class="section-body">
          <h2 class="section-title"> Daftar Sub-Menu RUMi App </h2>
          <p class="section-lead"> </p>
            ...
            <?php endif; ?>
            <?= form_error('menu', ''); ?> <?= $this->session->flashdata('message'); ?>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <table class="table table-hover" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($submenu as $sm) :
                                            if ( $sm['submenu_id'] == 1 || $sm['submenu_id'] == 2 || $sm['submenu_id'] == 3 || $sm['submenu_id'] == 4 || $sm['submenu_id'] == 5 ) {continue;}
                                        ?>
                                            <tr>
                                                <th scope="row"><?= $i; ?></th>
                                                <td><?= $sm['title']; ?></td>
                                                ...
                                                <td><?= $sm['is_active']; ?></td>
                                                <td>
                                                    <a href="" class="badge badge-success" data-toggle="modal" data-target="#editSubmenuModal<?=$sm['submenu_id'];?>">Edit</a>
                                                    <a href="<?= base_url('/menu/deletesubmenu/'); ?><?= $sm['submenu_id']; ?>" class="badge badge-danger" onclick="return confirm('apakah anda yakin akan menghapus submenu: <?= $sm['title']; ?>?')">Delete</a>
                                                </td>
    ...
    <!-- Modal Edit -->
    <?php foreach ($submenu as $sm) : ?>
        <div class="modal fade" id="editSubmenuModal<?=$sm['submenu_id'];?>" tabindex="-1" role="dialog" aria-labelledby="editSubmenuModalTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="<?= base_url('menu/updatesubmenu/'.$sm['submenu_id'])?>" method="POST">
                        <div class="modal-body">
                            <div class="form-group">
